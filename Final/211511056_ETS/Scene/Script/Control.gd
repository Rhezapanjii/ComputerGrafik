...
func _on_Control_draw():
	...
	drone(Vector2(512,300))
	lampu(Vector2(512,300),size)
	gedung(Vector2(512,300),22,22)
#	gedung(Vector2(512,300),0,0)
	garis.put_pixel_all(drone,Color.cadetblue)
	garis.put_pixel_all(gedung,Color.cadetblue)
