...
func _draw():
	midpoint_ellipsis(Vector2(500, 280), 50, 100 , Color.pink)
	midpoint_ellipsis(Vector2(500, 280), 100, 50 , Color.pink)
	midpoint_ellipsis(Vector2(500, 280), 100, 200 , Color.pink)
	midpoint_ellipsis(Vector2(500, 280), 200, 100 , Color.pink)
