...
func _draw():
	midpoint_ellipsis(Vector2(500, 280), 60, 120 , Color.brown)
	midpoint_ellipsis(Vector2(500, 280), 120, 60 , Color.brown)
	midpoint_ellipsis(Vector2(500, 280), 120, 220 , Color.brown)
	midpoint_ellipsis(Vector2(500, 280), 225, 125 , Color.brown)
	midpoint_ellipsis(Vector2(500, 280), 60, 120 , Color.brown)
	midpoint_ellipsis(Vector2(500, 280), 120, 60 , Color.brown)
	midpoint_ellipsis(Vector2(500, 280), 60, 160 , Color.brown)
	midpoint_ellipsis(Vector2(500, 280), 170, 70 , Color.brown)
