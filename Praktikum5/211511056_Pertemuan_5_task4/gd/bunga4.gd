...
func _draw():
	...
	var t2 = rotasi(90, [300 + 100,300], [300, 300])
	var t3 = rotasi(180, [300 + 100,300], [300, 300])
	var t4 = rotasi(270, [300 + 100,300], [300, 300])
	midpoint_ellipsis(Vector2(t1[0], t1[1]), 100, 50 , Color.green)
	midpoint_ellipsis(Vector2(t2[0], t2[1]), 50, 100 , Color.green)
	midpoint_ellipsis(Vector2(t3[0], t3[1]), 100, 50 , Color.green)
	midpoint_ellipsis(Vector2(t4[0], t4[1]), 50, 100 , Color.green)
